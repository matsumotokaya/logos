...
| [Freehand Lab](freehand/README.md) | —(画面を持たない) | 探索 | 🔬 実験1本目(2026-08-17) | **いまの出力が動画になっていない**ので、まず制約なしに1本ちゃんと作る。言葉・BGM・構成はそのまま、**デザインとアニメーションと素材の使い方だけ**を作り直し、テンプレートへの持ち帰り方は現物を見てから決める |
