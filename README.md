...
| `/brands`                      | **ブランド管理の主要画面**。共通の左ペインにOrganization→Brand→ロゴ／LP／動画をネスト表示(Organization > Brand Entity > ロゴ一覧／動画一覧／LP一覧 > 個別アイテム)し、右ペインだけをURL単位で切り替える。旧`/businesses`は互換リダイレクト                                                                                                                                                                                                                                                                                                                                                                                                                                       |
