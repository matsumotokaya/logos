...
| `/labs` | **研究所インデックス**(noindex)。表現R&Dのラボ群: 稼働中の [Motion Lab](labs/motion/README.md)(`/labs/motion`)と、準備中の Image / Video / Workflow Lab。全体像は [labs/README.md](labs/README.md)。旧 `/lab` は `/labs/motion` へリダイレクト |
