...
| [migration-log.md](migration-log.md) | migration `0023`〜`0055` が**なぜ在るのか**の記録。ルートREADMEのSupabaseセットアップ節に手順と同じ段落で埋まっていたものを切り出したもの。適用済みかどうかは記録ではなく `list_migrations` で確認する | 2026-08-21 |
